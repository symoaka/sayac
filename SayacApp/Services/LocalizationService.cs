...
public sealed class LocalizationService : INotifyPropertyChanged
{
    ...
    private static readonly Dictionary<string, string> Tr = new()
    {
        ...
        ["RecoverMini"] = "Miniyi geri getir",
        ["Show"] = "Göster",
        ["All"] = "Hepsi",
        ["Language"] = "Dil",
        ["Appearance"] = "Görünüm",
        ["Theme"] = "Tema",
        ["CounterStyle"] = "Sayaç stili",
        ["StyleAnimated"] = "Animasyonlu",
        ["StyleMinimal"] = "Minimal",
        ["PerformanceMode"] = "Performans modu",
        ["RestartRequired"] = "Yeniden başlatınca etkin olur. Yazılım çizimi kullanır; belleği çoğunlukla Windows'ta düşürür.",
        ["ThemeSystem"] = "Sistem",
        ["ThemeLight"] = "Açık",
        ["ThemeDark"] = "Koyu",
        ...
        ["TrayRecoverMini"] = "Miniyi Geri Getir",
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["RecoverMini"] = "Recover mini overlay",
        ["Show"] = "Show",
        ["All"] = "All",
        ["Language"] = "Language",
        ...
        ["RestartRequired"] = "Applies after restart. Uses software rendering; mainly lowers memory on Windows.",
        ["ThemeSystem"] = "System",
        ["ThemeLight"] = "Light",
        ["ThemeDark"] = "Dark",
